...
<form name="frmthem" method="post" action="<?php WEBROOT . 'index.php/tour/edit'.$tours['maTour']; ?>" enctype="multipart/form-data">


  <div class="col-sm-1"></div>
  <div class="col-sm-10"><h3 align="center"> Thay đổi thông tin tour</h3></div>
  <div class="col-sm-1"></div>
...
<div class="col-sm-6"><button type="submit" class="btn btn-danger">Sửa</button></div>
</form>
</div>
<br>
